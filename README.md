...
### 📖 New to Glide? Read the [**User Guide**](GUIDE.md)
...
| 🪟 **Windows** | `…-setup.exe` or `.msi` — `x64` or `arm64` | SmartScreen warning → **More info** → **Run anyway** (not yet signed) |

See the [User Guide](GUIDE.md#first-time-setup) for step-by-step setup.
...
(`latest.json`). Source and issues live in the main Glide project.
